            ...
            <div class="col-md-9 col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Modifier un activite</h4>
                    </div>
                    <div class="card-content">
                        <div class="card-body">
                            <form class="form form-vertical" method="POST"
                                action="{{ route('Activite.update', $activite->id) }}">
                                @csrf
                                @method('PUT')
                                <div class="form-body">
                                    <div class="row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="position-relative">
                                                    <textarea type="text" name="description"class="form-control @error('description') is-invalid @enderror"
                                                        value="{{ old('description') }}" rows="3" placeholder="Description de Activite">{{$activite->description}}</textarea>
                                                    @error('description')
                                            ...
                                            <div class="form-group ">
                                                ...
                                                <div class="position-relative">
                                                    <input type="time" name="duree" class="form-control"
                                                        placeholder="Duree" value="{{ old('Duree', $activite->duree) }}">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group has-icon-left">
                                                ...
                                                <div class="form-group">
                                                    <select class="choices form-select"
                                                        name="technicien_id">
                                                        <option value="" disabled>Sélectionner votre
                                                            technicien</option>
                                                        @foreach ($techniciens as $technicien)
                                                            <option value="{{ $technicien->id }}"
                                                                {{ $technicien->id == $activite->technicien_id ? 'selected' : '' }}>
                                                    ...
                                                    <select name="tache_id" class="choices form-select">
                                                        ...
                                                        @foreach ($taches as $tache)
                                                            <option value="{{ $tache->id }}"
                                                                {{ $tache->id == $activite->tache_id ? 'selected' : '' }}>
                                                    ...
                                                    <select name="etat_id" class="choices form-select">
                                                        ...
                                                        @foreach ($etats as $etat)
                                                            <option value="{{ $etat->id }}"
                                                                {{ $etat->id == $activite->etat_id ? 'selected' : '' }}>
                                                                {{ $etat->etat }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                        ...
                                        <div class="col-12 d-flex justify-content-end">
                                            <button type="submit" class="btn btn-primary me-1 mb-1">Modefier
                                                activite</button>
